#### Stylo, éditeur sémantique pour les sciences humaines

<!-- .element: style="padding-top:2rem" -->

##### remettre l'édition scientifique dans les mains de l'auteur
##### écrire dans l'environnement numérique = écrire + structurer
...
Parce qu'un auteur a des compétences sémantiques et non des compétences numériques,

il faut un éditeur qui soit:

- Plus simple <i class="fa fa-arrow-right"></i> moins d'options, moins de fonctions, interface claire
- Plus riche <i class="fa fa-arrow-right"></i> markup, URI, gestion bibliographique, métadonnées, outputs multiples
- Sémantique <i class="fa fa-arrow-right"></i> WYSIWYM
...
- Plusieurs systèmes d'écriture <i class="fa fa-arrow-right"></i> _chaîne modulable_
- WYSIWYM <i class="fa fa-arrow-right"></i> _est affiché ce qui est signifié_
- Plusieurs systèmes de balisage <i class="fa fa-arrow-right"></i> _souris, raccourcis, markdown_
...
![logo Erudit](img/erudit-logotype-blanc.png) <!-- .element: class="logo" style="width:15%;padding: 1px" -->

%%%%%%%%%%%%%%%%%%SECTIONmoveRight%%%%%%%%%%%%%%%%%%

#### Une application modulaire

<i class="fa fa-arrow-right"></i> 3 modules principaux + modules additionnels:
